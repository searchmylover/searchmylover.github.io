...
function F3() {
  ...
  setTimeout(function() {
    ...
    step: (state, BAR) => {
      ...
      if (CUR < 8) {
        TEX = "Registering with your instagram ID <span class='t-normal'>to @searchmylover account as premium user</span>...";
      } else if (CUR >= 8 && CUR < 32) {
        TEX = "Adding <span class='t-normal'>@searchmylover " + SELECTEDTINDER + "</span> membership...";
